var multilang = {
    ...
    data : {
        "fr" : {
            ...
            "caption_body": "Salut,</br>Je suis un designer UI/UX marocain avec plus de 6 ans d'expérience, spécialisé dans la création de designs centrés sur l'utilisateur et visuellement attrayants. Je maîtrise HTML, CSS et JavaScript, ce qui me permet de construire des prototypes interactifs qui donnent vie aux idées.</br> J'ai géré avec succès divers projets, travaillant en étroite collaboration avec les équipes pour garantir des livraisons dans les délais. Mon expertise inclut la réalisation de wireframes, de prototypes, de tests d'usabilité et de design visuel. Je suis toujours désireux d'apprendre et d'explorer les nouvelles tendances en design, et je suis enthousiaste à l'idée de collaborer avec des équipes innovantes pour créer des expériences utilisateur exceptionnelles.",
